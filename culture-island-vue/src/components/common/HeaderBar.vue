...
<template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <router-link class="navbar-brand col-md-3 ms-md-5" :to="{ name: 'home' }"
        >Culture.island</router-link
      >
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav col-md-5 ms-md-auto mb-3 mb-lg-0">
          <li class="nav-item col-md-3">
            <router-link :to="{ name: 'culturecalendar' }" class="nav-link active"
              >공연 달력</router-link
            >
            <!-- <a class="nav-link active" aria-current="page" href="#">공연 달력</a> -->
          </li>
          <li class="nav-item col-md-3">
            <router-link :to="{ name: 'culturemap' }" class="nav-link active"
              >공연 지도</router-link
            >
          ...
          <li class="nav-item col-md-3">
            <router-link
              :to="{ name: 'culturelist', params: { pageno: 1 } }"
        ...
        <div class="modal-body">
          <form @submit.prevent="login">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="ms-1"
                ><a class="text-secondary text-decoration-underline" href="/register"
                  >회원가입</a
                ></span
              >
